...
<div class="container1">
  ...
  <br>
      <article class="container">
        <div class="formBox">
		      <form id="myForm" name="myForm" class="hebrew" action="pageAfterPreferences2.php" method="post" onsubmit="return validateForm()">
    ...
        success: function(data){
      ...
      for (i = 6; i < 11; i++) {
        if (arr[i] !== "") {
          ...
          add += "<input type='radio' name='" + (actionName) + "'value='5'> " + arr[19] + "<br><hr>";
