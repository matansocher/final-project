...
$conn->query("set names 'utf8'");
  ...
  $queryGetHeaders = $conn->query("SELECT * FROM Page WHERE Name='feelings'");
 ...
 $queryGetDetails = $conn->query("SELECT * FROM Feelings WHERE ID=1");
   ...
   if ($queryGetDetails->num_rows >= 0) {
     ...
     $queryGetDetails2 = $conn->query("SELECT * FROM Feelings WHERE ID=2");
