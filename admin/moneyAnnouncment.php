        ...
        <div id="page-content-wrapper" text-align="center">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-cm-12">
                      <br>
                        <h2>אפשרות זכייה בכסף</h2>
                        <hr class="style18">
                      </div>
                  </div>

                  <button class="btn btn-primary" onclick=" window.open('../gameExperimentNew/moneyAnnouncment.php','_blank')">תצוגה מקדימה</button>

                  <form class="hebrew" method="post" action="savedata/saveDataMoneyAnnouncment.php" onsubmit="return validate()">
                    <div class="form-group">
                      <h3 class="hebrew">:כותרת</h3>
                      <textarea type="text" id="header" name="header" placeholder="כותרת" rows="1" cols="66"></textarea><br>
                      <h3 class="hebrew">:תוכן</h3>
                      <textarea type="text" class="content" id="content" name="content" placeholder="מלל הסבר" rows="6" cols="66"></textarea><br>
                    </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
        success: function(data){
      ...
      $("#content1").html(arr[1]);
      var updateTextArea1 = document.getElementById("content1").textContent;
      document.getElementById("content").value = updateTextArea1;
          }
      });
     });
