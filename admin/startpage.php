        ...
        <div id="page-content-wrapper" text-align="center">
            <div class="container-fluid">
                <div class="row">
                  ...
                  <button class="btn btn-primary" onclick=" window.open('../startpage.php','_blank')">תצוגה מקדימה</button>

                  <form class="hebrew" method="post" action="savedata/saveDataStartPage.php" onsubmit="return validate()">
                    <div class="form-group">
                      <h3 class="hebrew">:כותרת</h3>
                        <textarea type="text"  id="header" name="header" placeholder="כותרת דף פתיחה" rows="2" cols="66" class="header"></textarea>
                      <h3 class="hebrew">:תוכן</h3>
                      <textarea type="text"  id="content" name="content" placeholder="מלל דף פתיחה" rows="6" cols="66" class="content"></textarea>
...
<!-- /#wrapper -->
    ...
    <script type='text/javascript'>
        ...
        $('.header:not(.focus)').keyup(function(){
            var value = $(this).val();
            var contentAttr = $(this).attr('name');
              $('.'+contentAttr+'').html(value.replace(/\r?\n/g,'<br/>'));
        })
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
        success: function(data){
      ...
      $("#header1").html(arr[0]);
      var updateTextArea1 = document.getElementById("header1").textContent;
      document.getElementById("header").value = updateTextArea1;
      $("#content1").html(arr[1]);
      var updateTextArea2= document.getElementById("content1").textContent;
      document.getElementById("content").value = updateTextArea2;
          }
      });
     });
