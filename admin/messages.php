        ...
        <div id="page-content-wrapper" text-align="center">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-cm-12">
                      <br>
                        <h2><img src="images/msg.png" height="50px">הודעות</h2>
                        <br>
...
<!-- /#wrapper -->
    ...
    $.ajax({
        type: "GET",
        url: "../getDataToPages/getDataToMessages.php",
        success: function(data){
      ...
      var header="<tr id=Head><td width=15><b>הודעה</b></td><td width=15><b> מספר קבוצת מדגם</b></td><td width=15><b>מספר ניסוי</b></td><td width=15><b>מספר קבוצת מחקר</b></td><td width=15><b>תאריך</b></td><td width=15><b>מספר משתמש</b></td></tr>";
    $("#tblMessages").append(header);
      for (i = 0; i < arr.length; i++) {
        var row="<tr><td>"+arr[i+5]+"</td><td>"+arr[i+4]+"</td><td>"+arr[i+3]+"</td><td>"+arr[i+2]+"</td><td>"+arr[i+1]+"</td><td>"+arr[i]+"</td></tr>";
        $("#tblMessages").append(row);
        i=i+5;
      }
