        ...
        <div id="page-content-wrapper" text-align="center">
            <div class="container-fluid">
                <div class="row">
                  ...
                  <button class="btn btn-primary" onclick=" window.open('../questionnaireExperiment/helpTask.php','_blank')">תצוגה מקדימה</button>

                  <form class="hebrew" method="post" action="savedata/saveDataHelpTask.php" onsubmit="return validate()">
                    <div class="form-group">
                      ...
                      <h3 class="hebrew">:מלל הסבר משימת עזרה</h3>
                      <textarea type="text" class="description hebrew" id="description" name="description" placeholder="הסבר" rows="6" cols="66"></textarea><br>
