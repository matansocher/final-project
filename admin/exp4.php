                ...
                <div class="row">
                    <div class="col-cm-12">
                      ...
                      <div class="content">
                        ...
                        <a href="sentenceCompletion.php" class="myButton">השלמת משפטים</a><br><br>
                        <a href="moneyAnnouncment.php" class="myButton">אפשרות זכייה בכסף</a><br><br>
                        <a href="panas.php" class="myButton">Panas</a><br><br>
                        <a href="feelings.php" class="myButton">שאלון אווירה</a><br><br>
                        <a href="paymentAndDonation.php" class="myButton">דף תרומה\קבלת כסף</a><br><br>
