        ...
        <div id="page-content-wrapper" text-align="center">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-cm-12">
                      <br>
                      <h2>שאלון העדפות 2</h2>
                        <hr class="style18">
                      </div>
                  </div>

                  <button class="btn btn-primary" onclick=" window.open('../questionnaireExperiment/preferences21.php','_blank')">תצוגה מקדימה - דף 2</button>
                  <button class="btn btn-primary" onclick=" window.open('../questionnaireExperiment/preferences22.php','_blank')">תצוגה מקדימה - דף 1</button>

                  <form class="hebrew" method="post" action="savedata/saveDataPreferences2.php" onsubmit="return validate()">
                    <div class="form-group">
                      <h3 class="hebrew">:כותרת שאלון העדפות 2</h3>
                      <textarea type="text" class=" hebrew" id="headerPreferences" name="headerPreferences" placeholder="כותרת שאלון העדפות 2" rows="1" cols="66"></textarea><br>
                      <h3 class="hebrew">:מלל הסבר שאלון העדפות 2</h3>
                        <textarea type="text" class="explanationPreferences hebrew" id="explanationPreferences" name="explanationPreferences" placeholder="מלל הסבר שאלון העדפות 2" rows="6" cols="66"></textarea><br>
...
<script type="text/javascript">
  $(document).ready(function(){
    $.ajax({
        type: "GET",
        url: "../getDataToPages/getDataToPreferences2.php",
