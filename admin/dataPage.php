        ...
        <div id="page-content-wrapper" text-align="center">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-cm-12">
                      <br>
                        <h2><img src="images/dbase.png" height="60px">מאגר נתונים</h2>
                        <br>
                      <div class="content">

                        <a href="viewData.php" target="_blank" class="myButton">צפייה</a><br><br>
                        <a href="exportDataPage.php" class="myButton">יצוא</a><br><br>
